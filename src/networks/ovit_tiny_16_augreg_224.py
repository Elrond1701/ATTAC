...
class OVit_tiny_16_augreg_224(nn.Module):
    ...
    def __init__(self, num_classes=100, pretrained=False):
        ...
        # filename = '/networks/pretrained_weights/augreg_Ti_16-i1k-300ep-lr_0.001-aug_light1-wd_0.1-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.01-res_224.npz'

        filename = './networks/pretrained_weights/S_16-i21k-300ep-lr_0.001-aug_light1-wd_0.03-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.03-res_224.npz'
        #import ipdb; ipdb.set_trace()
        self.ovit = OVisionTransformer(embed_dim=384, num_classes=0, num_heads=6)
        # if pretrained:
