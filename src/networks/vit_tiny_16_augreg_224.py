...
class Vit_tiny_16_augreg_224(nn.Module):
    ...
    def __init__(self, num_classes=100, pretrained=False):
        ...
        #wget https://storage.googleapis.com/vit_models/augreg/Ti_16-i1k-300ep-lr_0.001-aug_light1-wd_0.1-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.01-res_224.npz

        filename = '/hy-tmp/continual_learning_with_vit/src/networks/pretrained_weights/Ti_16-i1k-300ep-lr_0.001-aug_light1-wd_0.1-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.01-res_224.npz'
